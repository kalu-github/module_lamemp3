...
# leanback
-dontwarn lib.kalu.leanback.clazz.**
-keep class lib.kalu.leanback.clazz.**{*;}
-keep interface lib.kalu.leanback.clazz.** { *; }

-dontwarn com.owen.tvrecyclerview.**
-keep class com.owen.tvrecyclerview.**{*;}
-keep interface com.owen.tvrecyclerview.** { *; }

# ffmpeg-cmd
# ffmpeg
-dontwarn lib.kalu.ffmpegcmd.**
-keep class lib.kalu.ffmpegcmd.**{*;}
-keep interface lib.kalu.ffmpegcmd.** { *; }
...
#      public <init>();
# }
#-keep class * implements com.huan.qupeiyin.standard.base.BaseViewImpl { *;}
#-keep class * implements com.huan.qupeiyin.standard.base.BaseViewImpl  {
# }

 # bean
 -dontwarn com.huan.qupeiyin.standard.bean.**
 -keep class com.huan.qupeiyin.standard.bean.**{*;}
 -keep interface com.huan.qupeiyin.standard.bean.** { *; }
